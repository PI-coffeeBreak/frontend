    ...
    return(
        <>
            ...
            <div className="flex items-center h-screen">
                <div className="w-2/5 rounded-xl mx-auto bg-secondary h-3/5 z-10 flex flex-col items-center p-8 justify-center">
                    ...
                    <input type="password" placeholder="************" className="p-4 w-full mt-4 bg-base-200 h-16 rounded-xl"/>
                    <button className="w-2/3 h-10 btn btn-primary text-white mt-8 rounded-xl"><NavLink to="/homeinst">Continue</NavLink></button>
                    <p className="my-4">You don't have an account? <span className="text-primary font-bold hover:underline"><NavLink to="/register">Sign Up</NavLink></span></p>
                </div>
            </div>
        </>
